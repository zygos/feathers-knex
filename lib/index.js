...
class Service extends AdapterService {
  ...
  knexify (query, params, parentKey) {
    Object.keys(params || {}).forEach(key => {
      ...
      } else if (ARRAY_OPERATORS.includes(method)) {
        // TODO: allow non-varchar types
        // TODO: add escaping or knex.raw for prepared statement
        return operator === '='
          ? query.where(column, value)
          : query.where(column, operator, `ARRAY[${value.join(',')}]::varchar[]`);
      }
